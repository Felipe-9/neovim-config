return {
  -- { import = "plugins.dressing" }, -- Beautify
  -- { import = "plugins.fidget" }, -- Unnintrusive notifications
  -- { import = "plugins.minimap.vim" }, -- Minimap
  -- { import = "plugins.neotree" }, -- File tree
  -- { import = "plugins.noice" }, -- UI replace commandline, messages and popupmessages
  ...
  -- LSPs
  --
  -- { import = "plugins.lsp.ale" }, -- Async lint engine
  -- { import = "plugins.lsp.conform" }, -- formarter
